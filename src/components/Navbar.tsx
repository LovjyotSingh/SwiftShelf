        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          {user ? (
            <button
              ...
              className="luxury-button-secondary flex items-center gap-1.5 px-2 py-1.5 sm:px-3 sm:py-2 text-xs"
            ...
            >
              ...
              <span className="font-bold hidden sm:inline truncate max-w-[80px]">
                {user.name.split(' ')[0]}
              </span>
            </button>
          ) : (
            <button
              onClick={onOpenAuth}
              className="luxury-button flex items-center gap-1 px-2.5 py-1.5 sm:px-3.5 sm:py-2 text-xs"
          ...
          <button
            ...
            title="Toggle Admin BI Dashboard"
          >
          ...
          <button
            onClick={onOpenCart}
            className="luxury-button relative flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3.5 sm:py-2 text-xs"
            title="Open Cart"
          >
            <ShoppingBag className="w-4 h-4" />
            <span className="hidden sm:inline">Cart</span>
            {cartCount > 0 && (
              <span className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-cyan-400 text-black font-bold text-[10px] sm:text-[11px] flex items-center justify-center animate-pulse shadow-sm">
                {cartCount}
              </span>
            )}
          </button>
