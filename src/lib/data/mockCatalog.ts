...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Designed in collaboration with orthopedic surgeons. Features responsive German elastomeric mesh, 11-point ergonomic articulation, and synchronized recline tension control.',
    price: 749.0,
    originalPrice: 899.0,
    category: 'Ergonomics',
    rating: 4.95,
